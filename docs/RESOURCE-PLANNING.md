...
- [ ] Week view: ผลรวมทุกสัปดาห์ของเดือน = เลข month view ของเดือนนั้น (ทดสอบอย่างน้อย 2 คน × 2 เดือน รวมเดือนที่ release เริ่ม/จบกลางเดือน 1 เคส)
- [ ] Week view: มี label "ประมาณการ" + `~` นำหน้าตัวเลข และไม่มีทางแก้ไขข้อมูลจากมุมมองนี้
