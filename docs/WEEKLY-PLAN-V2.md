...
- [ ] กด "ยกไป next week" → รายการไปโผล่ในแผนสัปดาห์หน้า (title มี `↻ `, มี badge carry) + รายการต้นทางเปลี่ยนเป็น carried_over + checklist ข้อค้างตามไป ข้อเสร็จไม่ตาม
- [ ] กดซ้ำ / กดหลังเคยกดปุ่มสถานะ Carry ไว้แล้ว → ไม่เกิดรายการซ้ำในสัปดาห์หน้า
- [ ] เพิ่มแผนใหม่ให้สัปดาห์หน้าจาก recap ได้ แล้วกด WeekNav ไปสัปดาห์หน้าเห็นรายการตรงกัน
- [ ] ดูสัปดาห์อนาคตอยู่ → ไม่แสดง Recap

**F3 Meeting notes**
- [ ] พิมพ์แล้วหยุด ~1s ขึ้น "บันทึกแล้ว ✓" refresh แล้วโน้ตยังอยู่
- [ ] เปลี่ยนสัปดาห์ไป-กลับ โน้ตแสดงถูกสัปดาห์ ไม่เซฟทับข้ามสัปดาห์
- [ ] จันทร์กับศุกร์แยกกันอิสระ
